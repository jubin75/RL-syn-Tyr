...
import torch 
import argparse
from Ref_based_syn.env import SynthesisEnv
from Ref_based_syn.td3 import TD3
from Ref_based_syn.dock import DockingVina, get_docking_config_for_vina
from Ref_based_syn.utils import create_dir
...
env = SynthesisEnv()
with open('data/building_blocks_inland.csv', 'r') as f:
    starting_smi = [l.strip() for l in f.readlines()]
    print(len(starting_smi))
with open('data/template_top100.csv', 'r') as f:
